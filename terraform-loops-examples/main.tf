...
output "publicservereip0" {
   value = aws_instance.hsitmanagementpublicserver[0].public_ip
}

output "privateserverip0" {
  value = aws_instance.hsitmanagementpublicserver[0].private_ip
}

output "publicservereip1" {
   value = aws_instance.hsitmanagementpublicserver[1].public_ip
}

output "privateserverip1" {
  value = aws_instance.hsitmanagementpublicserver[1].private_ip
}

output "publicservereip2" {
   value = aws_instance.hsitmanagementpublicserver[2].public_ip
}

output "privateserverip2" {
  value = aws_instance.hsitmanagementpublicserver[2].private_ip
}
